...
result.consolidated (fix_now / defer / trajectory / sellability).

Fix waves between rounds: M17.2/M17.3 (round 1), M18 wave A (round 2→3),
M19 wave B (round 3→4), M20 wave C (round 4→5), M21 wave D (round 5→6).

Practice going forward (round-5 consolidator's directive): every round's
reports are written HERE at consolidation time — a trajectory whose middle is
gone cannot be measured.
