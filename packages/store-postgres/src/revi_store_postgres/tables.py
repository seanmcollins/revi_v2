...
# --- Monitors: the proactive surface (migration 0005) -------------------------
...
monitors_pins = sa.Table(
    ...
    sa.Column("spec", JSONB, nullable=False),
    sa.Column("monitor", JSONB, nullable=True),
    ...
    sa.Index("ix_revi_monitors_pins_tenant", "tenant"),
    schema=MONITORS_SCHEMA,
)
...
monitors_pin_results = sa.Table(
    ...
    sa.Column("payload", JSONB, nullable=False),
    sa.Index("ix_revi_monitors_pin_results_pin_loaded", "pin_id", "watermark_loaded_at"),
    schema=MONITORS_SCHEMA,
)
...
monitors_loads = sa.Table(
    ...
    sa.Column("evaluated_at", sa.DateTime(timezone=True), nullable=False),
    sa.Column("payload", JSONB, nullable=False),
    sa.Index("ix_revi_monitors_loads_tenant_loaded", "tenant", "watermark_loaded_at"),
    schema=MONITORS_SCHEMA,
)
